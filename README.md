# CodeFlute
**My experience** of using AI assist.
All the code and docs were generated by AI. My mindset was that try to guide AI do the works as much as poissible,
even git commands from muscle memory, let AI handle that.
